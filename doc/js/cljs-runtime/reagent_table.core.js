...
var G__27976 = evt.clientX;
var G__27977 = evt.clientY;
return (on_drag.cljs$core$IFn$_invoke$arity$2 ? on_drag.cljs$core$IFn$_invoke$arity$2(G__27976,G__27977) : on_drag.call(null,G__27976,G__27977));
});
});
...
var scroll_dist = (cljs.core.truth_(page)?view_height:(function (){var or__4223__auto__ = (function (){var and__4221__auto__ = cell;
...
var lower_bound = (function (){var x__4309__auto__ = drag_col;
var y__4310__auto__ = drop_col;
return ((x__4309__auto__ < y__4310__auto__) ? x__4309__auto__ : y__4310__auto__);
})();
var upper_bound = (function (){var x__4306__auto__ = drag_col;
var y__4307__auto__ = drop_col;
...
var G__27979 = (view_col + (1));
return (cur.cljs$core$IFn$_invoke$arity$1 ? cur.cljs$core$IFn$_invoke$arity$1(G__27979) : cur.call(null,G__27979));
} else {
...
var G__27980 = (view_col - (1));
return (cur.cljs$core$IFn$_invoke$arity$1 ? cur.cljs$core$IFn$_invoke$arity$1(G__27980) : cur.call(null,G__27980));
} else {
return null;
}
}
...
var G__28002 = cljs.core.rest(sorting__$1);
var G__28003 = true;
var G__28004 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [model_col,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569))], null));
sorting__$1 = G__28002;
found = G__28003;
result = G__28004;
continue;
} else {
var G__28005 = cljs.core.rest(sorting__$1);
var G__28006 = found;
var G__28007 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,column);
sorting__$1 = G__28005;
found = G__28006;
result = G__28007;
continue;
}
...
return cljs.core.second(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27983_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__27983_SHARP_),model_col);
}),sorting)));
}
});
...
var map__27986 = state;
var map__27986__$1 = cljs.core.__destructure_map(map__27986);
var draggable = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27986__$1,new cljs.core.Keyword(null,"draggable","draggable",1676206163));
...
return cljs.core.reset_BANG_(data_atom,(function (){var G__27987 = cljs.core.deref(data_atom);
var G__27988 = column_model;
var G__27989 = new cljs.core.Keyword(null,"sorting","sorting",622249690).cljs$core$IFn$_invoke$arity$1(reagent_table.core.update_sort_columns_BANG_(model_col,state_atom,append));
return (sort_fn.cljs$core$IFn$_invoke$arity$3 ? sort_fn.cljs$core$IFn$_invoke$arity$3(G__27987,G__27988,G__27989) : sort_fn.call(null,G__27987,G__27988,G__27989));
})());
} else {
return null;
}
});
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),reagent_table.core.recursive_merge(new cljs.core.Keyword(null,"th","th",-545608566).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"draggable","draggable",1676206163),draggable,new cljs.core.Keyword(null,"on-drag-start","on-drag-start",-47712205),(function (p1__27984_SHARP_){
var G__27990_28008 = p1__27984_SHARP_.dataTransfer;
G__27990_28008.setData("text/plain","");
...
}),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),new cljs.core.Keyword(null,"style","style",-496642736)], null)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),(cljs.core.truth_(draggable)?"move":null),new cljs.core.Keyword(null,"display","display",242065432),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(col_hidden,model_col))?"none":null)], null),(cljs.core.truth_((function (){var and__4221__auto__ = new cljs.core.Keyword(null,"col-reordering","col-reordering",-165014502).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(and__4221__auto__)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"border-right","border-right",-668932860),"6px solid #3366CC"], null):null)], 0))], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding-right","padding-right",-1250249681),(50)], null)], null),new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(render_info)], null),(cljs.core.truth_((function (){var and__4221__auto__ = sort_fn;
if(cljs.core.truth_(and__4221__auto__)){
return sortable;
} else {
return and__4221__auto__;
}
})())?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"text-align","text-align",1786091845),"center",new cljs.core.Keyword(null,"height","height",1025178622),"1.5em",new cljs.core.Keyword(null,"width","width",-384071477),"1.5em",new cljs.core.Keyword(null,"right","right",-452581833),"15px",new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (p1__27985_SHARP_){
return sort_click_fn(p1__27985_SHARP_.ctrlKey);
})], null),(function (){var pred__27991 = cljs.core._EQ_;
var expr__27992 = reagent_table.core.is_sorting(new cljs.core.Keyword(null,"sorting","sorting",622249690).cljs$core$IFn$_invoke$arity$1(state),render_info,model_col);
if(cljs.core.truth_((pred__27991.cljs$core$IFn$_invoke$arity$2 ? pred__27991.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"asc","asc",356854569),expr__27992) : pred__27991.call(null,new cljs.core.Keyword(null,"asc","asc",356854569),expr__27992)))){
return " \u25B2";
} else {
if(cljs.core.truth_((pred__27991.cljs$core$IFn$_invoke$arity$2 ? pred__27991.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"desc","desc",2093485764),expr__27992) : pred__27991.call(null,new cljs.core.Keyword(null,"desc","desc",2093485764),expr__27992)))){
return " \u25BC";
} else {
if(cljs.core.truth_((pred__27991.cljs$core$IFn$_invoke$arity$2 ? pred__27991.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"none","none",1333468478),expr__27992) : pred__27991.call(null,new cljs.core.Keyword(null,"none","none",1333468478),expr__27992)))){
return null;
} else {
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_table.core.header_cell_fn,render_info,view_col,model_col,config,state_atom,data_atom], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(render_info);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return model_col;
...
var model_col = reagent_table.core.column_index_to_model(state_atom,view_col);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"border-right","border-right",-668932860),(cljs.core.truth_((function (){var and__4221__auto__ = new cljs.core.Keyword(null,"col-reordering","col-reordering",-165014502).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(view_col,new cljs.core.Keyword(null,"col-hover","col-hover",-1561137880).cljs$core$IFn$_invoke$arity$1(state));
} else {
return and__4221__auto__;
}
})())?"2px solid #3366CC":null),new cljs.core.Keyword(null,"display","display",242065432),(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(col_hidden,model_col))?"none":null)], null)], null),(function (){var G__27994 = (col_model.cljs$core$IFn$_invoke$arity$1 ? col_model.cljs$core$IFn$_invoke$arity$1(model_col) : col_model.call(null,model_col));
var G__27995 = row;
var G__27996 = row_num;
var G__27997 = model_col;
return (cell_fn.cljs$core$IFn$_invoke$arity$4 ? cell_fn.cljs$core$IFn$_invoke$arity$4(G__27994,G__27995,G__27996,G__27997) : cell_fn.call(null,G__27994,G__27995,G__27996,G__27997));
...
}),(function (){var or__4223__auto__ = col_model;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return row;
...
return null;
})], null),li_config),new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(render_info)," ",(cljs.core.truth_(cljs.core.deref(hidden_a))?"\u2610":"\u2611")], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(render_info);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return model_col;
...
return reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (){
...
var state_atom = (function (){var or__4223__auto__ = new cljs.core.Keyword(null,"table-state","table-state",-1662785974).cljs$core$IFn$_invoke$arity$1(config__$1);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var map__27998 = config__$1;
var map__27998__$1 = cljs.core.__destructure_map(map__27998);
var render_cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27998__$1,new cljs.core.Keyword(null,"render-cell","render-cell",-515359581));
var column_model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27998__$1,new cljs.core.Keyword(null,"column-model","column-model",1553156630));
if(cljs.core.truth_((function (){var and__4221__auto__ = render_cell;
if(cljs.core.truth_(and__4221__auto__)){
return column_model;
} else {
return and__4221__auto__;
...
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var temp__5753__auto__ = new cljs.core.Keyword(null,"column-selection","column-selection",-282189655).cljs$core$IFn$_invoke$arity$1(config__$1);
if(cljs.core.truth_(temp__5753__auto__)){

...
return [(function (){var pred__8652 = cljs.core.instance_QMARK_;
var expr__8653 = reactive_val;
if(cljs.core.truth_((pred__8652.cljs$core$IFn$_invoke$arity$2 ? pred__8652.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__8653) : pred__8652.call(null,reagent.ratom.RAtom,expr__8653)))){
return "ra";
} else {
if(cljs.core.truth_((pred__8652.cljs$core$IFn$_invoke$arity$2 ? pred__8652.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__8653) : pred__8652.call(null,reagent.ratom.RCursor,expr__8653)))){
return "rc";
} else {
if(cljs.core.truth_((pred__8652.cljs$core$IFn$_invoke$arity$2 ? pred__8652.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__8653) : pred__8652.call(null,reagent.ratom.Reaction,expr__8653)))){
return "rx";
} else {
if(cljs.core.truth_((pred__8652.cljs$core$IFn$_invoke$arity$2 ? pred__8652.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__8653) : pred__8652.call(null,reagent.ratom.Track,expr__8653)))){
return "tr";
} else {
return "other";
}

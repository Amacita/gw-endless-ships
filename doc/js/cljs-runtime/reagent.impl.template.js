...
var G__8175 = o;
goog.object.set(G__8175,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__8325__i < G__8325__a.length) {G__8325__a[G__8325__i] = arguments[G__8325__i + 0]; ++G__8325__i;}
  args = new cljs.core.IndexedSeq(G__8325__a,0,null);
} 
...
var G__8185 = o;
goog.object.set(G__8185,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__8334__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
var G__8186 = props;
var G__8186__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8186,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8186);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8186__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__8186__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8191 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8191,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8191;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__8198){
var map__8199 = p__8198;
var map__8199__$1 = cljs.core.__destructure_map(map__8199);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8199__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__8204_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__8204_SHARP_);
}));
} else {
return null;
}
...
var vec__8220 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8220,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8220,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8220,(2),null);
...
var temp__5757__auto___8369 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___8369 == null)){
} else {
var key_8370 = temp__5757__auto___8369;
(jsprops.key = key_8370);
}
...
var temp__5757__auto___8371 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___8371 == null)){
} else {
var key_8372 = temp__5757__auto___8371;
(jsprops.key = key_8372);
}
...
var G__8246 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__8246) : reagent.impl.template.as_element.call(null,G__8246));
} else {
var temp__5757__auto___8379 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___8379 == null)){
} else {
var key_8380 = temp__5757__auto___8379;
(jsprops.key = key_8380);
}
...
var G__8264 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__8264)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__8264)){
return x;
} else {
...
var len__4829__auto___8390 = arguments.length;
var i__4830__auto___8391 = (0);
while(true){
if((i__4830__auto___8391 < len__4829__auto___8390)){
args__4835__auto__.push((arguments[i__4830__auto___8391]));

var G__8393 = (i__4830__auto___8391 + (1));
i__4830__auto___8391 = G__8393;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4836__auto__);
});
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8269){
var G__8270 = cljs.core.first(seq8269);
var seq8269__$1 = cljs.core.next(seq8269);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8270,seq8269__$1);
}));
...
break;
default:
var G__8421 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__8421;
continue;
...
var ctx = ({});
var vec__8306 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8306,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8306,(1),null);
...
var G__8315 = (cljs.core.count(argv) - first_child);
switch (G__8315) {
case (0):

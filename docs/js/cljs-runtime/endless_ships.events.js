...
endless_ships.events.initial_outfit_settings = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (settings,p__27383){
var vec__27384 = p__27383;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27384,(0),null);
var map__27387 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27384,(1),null);
var map__27387__$1 = cljs.core.__destructure_map(map__27387);
var initial_ordering = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27387__$1,new cljs.core.Keyword(null,"initial-ordering","initial-ordering",247801785));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("endless-ships.events","initialize","endless-ships.events/initialize",1940589872),(function (p__27388,_){
var map__27389 = p__27388;
var map__27389__$1 = cljs.core.__destructure_map(map__27389);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27389__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (indexed,p__27390){
var map__27391 = p__27390;
var map__27391__$1 = cljs.core.__destructure_map(map__27391);
var item = map__27391__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27391__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (grouped,p__27392){
var map__27393 = p__27392;
var map__27393__$1 = cljs.core.__destructure_map(map__27393);
var mod = map__27393__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27393__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var modification = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27393__$1,new cljs.core.Keyword(null,"modification","modification",614103573));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("endless-ships.events","data-loaded","endless-ships.events/data-loaded",2027853550),(function (db,p__27394){
var vec__27395 = p__27394;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27395,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27395,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("endless-ships.events","navigate-to","endless-ships.events/navigate-to",1779597913),(function (db,p__27398){
var vec__27399 = p__27398;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27399,(0),null);
var route = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27399,(1),null);
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",1556144875),entity_type,new cljs.core.Keyword(null,"ordering","ordering",1096406705)], null),(function (p__27402){
var map__27403 = p__27402;
var map__27403__$1 = cljs.core.__destructure_map(map__27403);
var column_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27403__$1,new cljs.core.Keyword(null,"column-name","column-name",551523580));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27403__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("endless-ships.events","toggle-ordering","endless-ships.events/toggle-ordering",26210934),(function (db,p__27404){
var vec__27405 = p__27404;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27405,(0),null);
var entity_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27405,(1),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27405,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("endless-ships.events","toggle-ships-race-filter","endless-ships.events/toggle-ships-race-filter",1336905685),(function (db,p__27408){
var vec__27409 = p__27408;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27409,(0),null);
var race = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27409,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("endless-ships.events","toggle-ships-category-filter","endless-ships.events/toggle-ships-category-filter",360017738),(function (db,p__27412){
var vec__27413 = p__27412;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27413,(0),null);
var category = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27413,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("endless-ships.events","toggle-ships-license-filter","endless-ships.events/toggle-ships-license-filter",1474231081),(function (db,p__27416){
var vec__27417 = p__27416;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27417,(0),null);
var license = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27417,(1),null);

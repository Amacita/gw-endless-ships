...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__10892){
var map__10893 = p__10892;
var map__10893__$1 = cljs.core.__destructure_map(map__10893);
var request = map__10893__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10893__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__10896 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__10896.cljs$core$IFn$_invoke$arity$1 ? fexpr__10896.cljs$core$IFn$_invoke$arity$1(response) : fexpr__10896.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__10897 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__10897.cljs$core$IFn$_invoke$arity$1 ? fexpr__10897.cljs$core$IFn$_invoke$arity$1(response) : fexpr__10897.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__10899){
var map__10900 = p__10899;
var map__10900__$1 = cljs.core.__destructure_map(map__10900);
var request = map__10900__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10900__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));

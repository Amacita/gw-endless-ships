...
var i_26942 = (0);
while(true){
if((i_26942 < arr.length)){
(arr[i_26942] = null);

var G__26947 = (i_26942 + (1));
i_26942 = G__26947;
continue;
} else {
}
...
var i_26965 = (self__.level + (1));
while(true){
if((i_26965 <= (new_level + (1)))){
(update[i_26965] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_26968 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_26968[i]));
} else {
x__$2.forward.push((((i < links_26968.length))?(links_26968[i]):null));
}

if((i < links_26968.length)){
(links_26968[i] = x__$2);
} else {
links_26968.push(x__$2);
}
...
var i_26978 = (0);
while(true){
if((i_26978 <= self__.level)){
var links_26979 = (update[i_26978]).forward;
if((x__$1 === (((i_26978 < links_26979.length))?(links_26979[i_26978]):null))){
(links_26979[i_26978] = (x__$1.forward[i_26978]));

var G__26985 = (i_26978 + (1));
i_26978 = G__26985;
continue;
} else {
var G__26986 = (i_26978 + (1));
i_26978 = G__26986;
continue;
}
} else {
...
var G__26994 = nx;
var G__27032 = (level__$1 - (1));
x = G__26994;
level__$1 = G__27032;
continue;
} else {
var G__27033 = x;
var G__27034 = (level__$1 - (1));
x = G__27033;
level__$1 = G__27034;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__27041 = nx;
var G__27042 = (level__$1 - (1));
x = G__27041;
level__$1 = G__27042;
continue;
} else {
var G__27044 = x;
var G__27045 = (level__$1 - (1));
x = G__27044;
level__$1 = G__27045;
continue;
}

...
var map__28492 = bidi.bidi.match_route(endless_ships.routes.routes,url);
var map__28492__$1 = cljs.core.__destructure_map(map__28492);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28492__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var route_params = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__28492__$1,new cljs.core.Keyword(null,"route-params","route-params",2111411055),cljs.core.PersistentArrayMap.EMPTY);
...
var G__28497 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("endless-ships.events","navigate-to","endless-ships.events/navigate-to",1779597913),matched_route], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__28497) : re_frame.core.dispatch.call(null,G__28497));
});
